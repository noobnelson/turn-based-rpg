...
public static class PathFinding
{
    ...
    public static List<Block> AvailableMoves(Block startBlock, int maxCost, List<List<Block>> blockPaths)
    {
    ...
    public static List<Block> AvailableAttackCells(Block startBlock, int maxCost)
    {
        List<Block> availableBlocks = new List<Block>();
        List<Block> accessedBlocks = new List<Block>() { startBlock };
        List<PathAndCost> incompletePathsWithCost = new List<PathAndCost>() {
